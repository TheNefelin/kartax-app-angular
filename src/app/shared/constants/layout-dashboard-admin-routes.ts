...
export const LAYOUT_DASHBOARD_ADMIN_NAVIGATION: DashboardRouteModel[] = [
  {
    name: 'Panel',
    route: ROUTES_CONSTANT.PROTECTED.ADMIN.DASHBOARD,
